...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post facilities_url, params: { facility: { name: @facility.name, shelter_id: @facility.shelter_id } }, as: :json
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { name: @facility.name, shelter_id: @facility.shelter_id } }, as: :json
    assert_response 200
  end
